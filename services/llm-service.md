...
id: llm-service
title: LLM Service
description: "Language model service providing FAQ and risk narrative generation capabilities"
tags: [Production]
connections: []
metadata:
  serviceType: llm
...
Provides access to a large language model for FAQ and risk narrative generation. Used by all skills in this skrpt.
